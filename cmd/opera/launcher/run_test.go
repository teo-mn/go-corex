...
import (
	...
	"github.com/corex-mn/go-corex/cmd/cmdtest"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "corex-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "corex-test" in exec().
	reexec.Register("corex-test", func() {
