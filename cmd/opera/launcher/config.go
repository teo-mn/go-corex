...
import (
	...
	"github.com/corex-mn/go-corex/evmcore"
	"github.com/corex-mn/go-corex/gossip"
	"github.com/corex-mn/go-corex/gossip/gasprice"
	"github.com/corex-mn/go-corex/integration"
	"github.com/corex-mn/go-corex/integration/makegenesis"
	"github.com/corex-mn/go-corex/opera"
	"github.com/corex-mn/go-corex/opera/genesisstore"
	futils "github.com/corex-mn/go-corex/utils"
...
var (
	...
	RPCGlobalGasCapFlag = cli.Uint64Flag{
		Name:  "rpc.gascap",
		Usage: "Sets a cap on gas that can be used in crx_call/estimateGas (0=infinite)",
		Value: gossip.DefaultConfig(cachescale.Identity).RPCGasCap,
	}
	RPCGlobalTxFeeCapFlag = cli.Float64Flag{
		Name:  "rpc.txfeecap",
		Usage: "Sets a cap on transaction fee (in CRX) that can be sent via the RPC APIs (0 = no cap)",
		Value: gossip.DefaultConfig(cachescale.Identity).RPCTxFeeCap,
	}

	AllowedOperaGenesisHashes = map[uint64]hash.Hash{
		opera.MainNetworkID: hash.HexToHash("0xb8088a929f52cc3cd32b08eb55a87e475668dac5a3e665d2216cf5febcb3d1d6"),
		opera.TestNetworkID: hash.HexToHash("0xb8088a929f52cc3cd32b08eb55a87e475668dac5a3e665d2216cf5febcb3d1d6"),
	}
)
...
func getOperaGenesis(ctx *cli.Context) integration.InputGenesis {
	...
	case ctx.GlobalIsSet(FakeNetFlag.Name):
		...
		fakeGenesisStore := makegenesis.FakeGenesisStore(num, futils.ToCrx(1000000000), futils.ToCrx(5000000))
...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "eth", "crx", "dag", "sfc", "abft", "web3")
	cfg.WSModules = append(cfg.WSModules, "eth", "crx", "dag", "sfc", "abft", "web3")
