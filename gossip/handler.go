...
import (
	...
	"github.com/corex-mn/corex-base/gossip/dagprocessor"
	"github.com/corex-mn/corex-base/gossip/dagstream"
	"github.com/corex-mn/corex-base/gossip/dagstream/streamleecher"
	"github.com/corex-mn/corex-base/gossip/dagstream/streamseeder"
	"github.com/corex-mn/corex-base/gossip/itemsfetcher"
	...
	"github.com/corex-mn/go-corex/eventcheck/parentlesscheck"
...
// newHandler returns a new Corex sub protocol manager. The Corex sub protocol manages peers capable
// with the Corex network.
func newHandler(
	c handlerConfig,
) (
	*ProtocolManager,
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping Corexchain protocol")
