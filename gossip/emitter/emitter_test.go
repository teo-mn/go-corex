...
import (
	...
	"github.com/corex-mn/go-corex/gossip/emitter/mock"
...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/corex-mn/go-corex/gossip/emitter External,TxPool,TxSigner,Signer
